 ...
 */
function verifyProjectSpecFiles(projectsDir: string, screenConsole: any = undefined) {
  if (!screenConsole)
 ...
 *
 */
function verifyProjectStorageFile(userDir: string, screenConsole: any = undefined) {
  if (!screenConsole)
    screenConsole = console.log;
 ...
 *
 */
function verifySettingsStorageFile(userDir: string, screenConsole: any = undefined) {
  if (!screenConsole)
    screenConsole = console.log;
 ...
 *
 */
function verifyCredentialsFiles(projectsDir: string, screenConsole: any = undefined) {
  if (!screenConsole)
    screenConsole = console.log;
