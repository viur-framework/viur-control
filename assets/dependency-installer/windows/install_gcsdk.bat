...
"%USERPROFILE%\google-cloud-sdk\install.bat" --quiet --usage-reporting true --path-update true --additional-components beta app-engine-python app-engine-python-extras
