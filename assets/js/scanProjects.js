...
const projectStorage = new Storage({"name": "projects"});
const versionsStorage = new Storage({"name": "versions"});
const gcloudProjectStorage = new Storage({"name": "gcloudProjects"});
...
class Project {
  constructor(directoryName,
              ...
              appengineDirectories = undefined,
...
function getProjects(event, windowId, subprocessIds, debug = false) {
  if (debug) {
